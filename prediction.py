...
def params_predict():
	...
	url = "http://127.0.0.1:5000/paramspredict?sepal_length={0}&sepal_width={1}&petal_length={2}&petal_width={3}".format(sepal_length,sepal_width,petal_length,petal_width)
